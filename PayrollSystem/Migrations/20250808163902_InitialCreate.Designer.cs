...
namespace PayrollSystem.Migrations
{
    ...
    [Migration("20250808163902_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollSystem.src.microservices.AuthenticationService.Models.User", b =>
                {
            ...
            modelBuilder.Entity("PayrollSystem.src.microservices.AuthenticationService.Models.UserRole", b =>
                {
                    b.Property<long>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PayrollSystem.src.microservices.Employee.Models.Employees", b =>
                {
                    b.Property<long>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PayrollSystem.src.microservices.AuthenticationService.Models.User", b =>
                {
                    b.HasOne("PayrollSystem.src.microservices.AuthenticationService.Models.UserRole", "Role")
                        .WithMany()
